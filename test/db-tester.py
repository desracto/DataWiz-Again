...
# q17 = text("CREATE TABLE Genre (genre_id INT PRIMARY KEY, genre_name VARCHAR(30))")
# q18 = text("CREATE TABLE Artist (artist_id INT PRIMARY KEY, artist_name VARCHAR(50), country VARCHAR(50), genre_id INT, FOREIGN KEY (genre_id) REFERENCES Genre(genre_id))")
# q19 = text("CREATE TABLE Album (album_id INT PRIMARY KEY, album_name VARCHAR(50), year INT, artist_id INT, FOREIGN KEY (artist_id) REFERENCES Artist(artist_id))")
# q20 = text("CREATE TABLE Song (song_id INT PRIMARY KEY, song_title VARCHAR(50), album_id INT, FOREIGN KEY (album_id) REFERENCES Album(album_id))")
...
# Q = text("DROP TABLE Flights")
# connection2.execute(Q)

# Q = text("DROP TABLE Genres")
# connection2.execute(Q)

# Q = text("DROP TABLE Inventory")
# connection2.execute(Q)

# Q = text("DROP TABLE Passengers")
# connection2.execute(Q)

# Q = text("DROP TABLE Products")
# connection2.execute(Q)
#---------------------------------------
