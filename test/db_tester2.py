...
def run(query_list):
    ...
    #     "select * FROM Artist",
    #     "select * FROM Song",
    #     "select * FROM Artist JOIN Song ON Album.album_id = Song.album_id",
    #     "select * FROM Artist JOIN Song ON Album.album_id = Song.album_id GROUP BY country",
    #     "select * FROM Artist JOIN Song ON Album.album_id = Song.album_id GROUP BY country ORDER BY country desc",
    #     "select count(artist_id), country FROM Artist JOIN Song ON Album.album_id = Song.album_id GROUP BY country ORDER BY country desc"
    # ]
