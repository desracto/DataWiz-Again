    ...
    <>
        ...
        <div className="Anim-intro-sec1">
            <div className="Anim-intro-sec1-Text">
                <img 
                    className="Anim-Intro-Sec1-Vec1" 
                    alt="" 
                    src={vector63} 
                />
                <div className="uncover-sql-magic">
                    Uncover SQL Magic
                </div>
            ...
            <img
                className="Anim-Intro-Sec1-Image"
                alt=""
                src={animMain}
            />
        </div>
        ...
        <div className="Anim-intro-sec2">
            <img
                className="Anim-Intro-Sec2-Image"
                alt=""
                src={animQuery}
            />    
            <div className="Anim-intro-sec2-Text">
                <img 
                    className="Anim-Intro-Sec2-Vec1" 
                    alt="" src={vector61} 
                />
        ...
        <div className="Anim-intro-sec3">
            ...
            <img
                className="Anim-Intro-Sec3-Image"
                alt=""
                src={animSavedQuery}
            />
        </div>
