...
const data = [
    ...
    },
    {
        ...
        answer: `Yes, both learners and instructors can access detailed quiz results and progress tracking to monitor performance and identify areas for improvement.`
    },
    {
